...
public class DownloaderTaskFragment extends Fragment {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		ArrayList<Integer> resIds= (ArrayList<Integer>) getArguments().get(MainActivity.TAG_FRIEND_RES_IDS);
		Integer[] resIdArray = new Integer[resIds.size()];
		for(int i = 0; i < resIds.size(); i++)
			resIdArray[i] = resIds.get(i);
		downTask.execute(resIdArray);
	...
	public class DownloaderTask extends AsyncTask<Integer[], Void, String[]> {
		...
		protected String[] doInBackground(Integer[]... params){
			String[] result = downloadTweets(params[0]);
			return result;
		}
