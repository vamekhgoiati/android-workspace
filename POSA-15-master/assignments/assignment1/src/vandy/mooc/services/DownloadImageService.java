...
public class DownloadImageService extends IntentService {
    ...
    public void onHandleIntent(Intent intent) {
        ...
        // @@ TODO -- you fill in here.
    	Uri downloadedImagePath = Utils.downloadImage(DownloadImageService.this, url, pathName);
        ...
        // @@ TODO -- you fill in here.
    	sendPath(messenger, downloadedImagePath, url);
    }
    ...
    private void sendPath(Messenger messenger, 
        ...
        Message message = makeReplyMessage(pathToImageFile, url);
        	...
        	try {
        		...
        		Log.e(getClass().getName(), "Exception while sending: ", ex);
        	}
    }
    ...
    private Message makeReplyMessage(Uri pathToImageFile,
        ...
        // succeeded or failed.
        // @@ TODO -- you fill in here.
        message.arg1 = pathToImageFile == null ? Activity.RESULT_CANCELED : Activity.RESULT_OK;
