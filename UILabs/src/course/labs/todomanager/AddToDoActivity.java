	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				Priority priority = Priority.values()[mPriorityRadioGroup.indexOfChild(mPriorityRadioGroup.findViewById(priorityButtonId))];

				// TODO - Get the current Status
				int statusButtonId = mStatusRadioGroup.getCheckedRadioButtonId();
				Status status = Status.values()[(Status.values().length - 1) - mStatusRadioGroup.indexOfChild(mStatusRadioGroup.findViewById(statusButtonId))];
